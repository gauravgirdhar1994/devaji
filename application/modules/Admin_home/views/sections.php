            ...
            <div class="row">
                  <div class="col-12">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <textarea class="form-control ckeditor" name="SliderDescription[]" id="editor<?php echo $i;l ?>" rows="5"><?php if(!empty($slider->SliderDescription)) echo $slider->SliderDescription; ?></textarea>
                          </div>
                        </div>
                      </div> -->
                                                      </div>
                          ...
                          <div class="form-group">
                            <label class="col-sm-3 col-form-label">Slider Content</label>
                            <div class="col-sm-9">
                              <textarea class="form-control" name="SliderDescription[]" id="SliderDescription" rows="5"></textarea>
                            </div>
                          </div>
                        </div> -->
                                                      </div>
