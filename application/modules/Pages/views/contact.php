      ...
      <div class="container">
            <div class="d-none d-sm-block">
                  ...
                  <div class="row">
                        ...
                        <div class="col-lg-8">
                              <form class="form-contact contact_form" action="javascript:void(0)" method="POST"
                  ...
                  <div class="row d-flex justify-content-between">
                        <div class="col-xl-8 col-lg-8 col-md-8">
                              <div class="single-method mb-40">
                                    ...
                                    <h5>For any queries or place order for our products, call us at:
                                          +91-123234-3434</h5>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4">
                              <div class="single-method mb-40">
                                    <a href="<?php echo base_url(); ?>contact" class="btn btn-primary btn-xl mt-50"
                                          download>Get in Touch</a>
                              </div>
                        </div>
                  </div>
            </div>
